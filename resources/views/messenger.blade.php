...
<html lang="en">
    ...
    <head>
        ...
        <title>Messenger - Fudou</title>

        <!-- Favicon -->
        <link rel="shortcut icon" href="./assets/img/f.png" type="image/x-icon">
  ...
  <script>
    ...
    var pusher = new Pusher('062466d7980967aa4b82', {
      cluster: 'eu',
